...
public class frmUtama extends javax.swing.JFrame {
    ...
    private String requestJson, URL = "", link = "", datajam = "", hari = "", noresep = "", task3 = "", task4 = "", task5 = "", task6 = "", task7 = "", task99 = "", kodepoli = "", kodedokter = "", kodebpjs = Sequel.cariIsi("select password_asuransi.kd_pj from password_asuransi");
...
//                        }
                        ...
                        //pasien Non JKN
                        userTableModel.tambahData("Menjalankan WS tambah antrian Mobile JKN Pasien Non BPJS/BJS Onsite");
                        ps = koneksi.prepareStatement(
                                                ...
                                                try {
                                                    ...
                                                    if (!rs.getString("kd_pj").equals(kodebpjs)) {
                                                        requestJson = JsonUtil.createObject()
                                                                ...
                                                                .put("kodedokter", Sequel.cariIsi("select maping_dokter_dpjpvclaim.kd_dokter_bpjs from maping_dokter_dpjpvclaim where maping_dokter_dpjpvclaim.kd_dokter=?", rs.getString("kd_dokter")))
                                                                .put("namadokter", rs.getString("nm_dokter"))
