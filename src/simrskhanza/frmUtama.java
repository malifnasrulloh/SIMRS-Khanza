...
import grafikanalisa.GrafikKeslingLimbahB3Pertanggal;
import grafikanalisa.GrafikKeslingLimbahDomestikBulan;
...
import grafikanalisa.GrafikMeninggalPerBulan;
...
import grafikanalisa.GrafikPerbaikanInventarisPerPelaksanaStatus;
...
import grafikanalisa.GrafikPeristiwaK3PerJenisLuka;
import grafikanalisa.GrafikPeristiwaK3PerJenisPekerjaan;
import grafikanalisa.GrafikPeristiwaK3PerLokasiKejadian;
...
import grafikanalisa.GrafikPorsiDietPerRuang;
import grafikanalisa.GrafikPorsiDietPerTahun;
...
import grafikanalisa.GrafikRegistrasiPerAgama;
import grafikanalisa.GrafikRegistrasiPerBahasa;
import grafikanalisa.GrafikRegistrasiPerBulan;
import grafikanalisa.GrafikRegistrasiPerCacat;
import grafikanalisa.GrafikRegistrasiPerCaraBayar;
import grafikanalisa.GrafikRegistrasiPerDokter;
import grafikanalisa.GrafikRegistrasiPerPekerjaan;
import grafikanalisa.GrafikRegistrasiPerPendidikan;
import grafikanalisa.GrafikRegistrasiPerPerujuk;
import grafikanalisa.GrafikRegistrasiPerSuku;
import grafikanalisa.GrafikRegistrasiPerTahun;
import grafikanalisa.GrafikRegistrasiPerTanggal;
import grafikanalisa.GrafikRegistrasiPerUmur;
import grafikanalisa.GrafikRegistrasiPoli;
...
import inventaris.KeslingPemakaiaanAirTanah;
...
import inventory.InventoryRingkasanPenerimaanBarangMedis;
import inventory.InventoryRingkasanPengajuanBarangMedis;
import inventory.InventoryRingkasanPenjualanBarangMedis;
import inventory.InventoryRingkasanPiutangBarangMedis;
...
import kepegawaian.K3RSDampakCideraPerTahun;
...
import pcraicra.PCRAICRAIdentifikasiRisikoUtilitas;
...
import viabarcode.LabKeslingRekapPembayaran;
...
import ziscsr.ZISJenisSimpananPenerimaDankes;
import ziscsr.ZISKamarMandiPenerimaDankes;
import ziscsr.ZISKategoriAsnafPenerimaDankes;
...
public class frmUtama extends javax.swing.JFrame {
    ...
    private boolean ADD_MENU_BY_NAME = false;
    ...
    private void initComponents() {
        ...
        MnTarif.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTarif.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTarif.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        MnTarif1.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnTarif1.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnTarif1.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        MnAntrianFarmasi.add(MnRekapHadir11);

        jMenu7.add(MnAntrianFarmasi);

        MnAntrianLaborat.setBackground(new java.awt.Color(255, 255, 254));
        MnAntrianLaborat.setForeground(new java.awt.Color(50, 90, 40));
        MnAntrianLaborat.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Create-Ticket24.png"))); // NOI18N
        MnAntrianLaborat.setText("Antrian Laborat");
        MnAntrianLaborat.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnAntrianLaborat.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        MnAntrianLaborat.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ...
        MnAntrianLaborat.add(MnInfoLaborat3);
...
private void MnGantiPasswordBtnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnGantiPasswordBtnLogActionPerformed
    ...
    private void btnToolLabActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnToolLabActionPerformed
        ...
        FlayMenu.add(btnPermintaanLabMB);
    ...
    private void MnInfoLaboratActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInfoLaboratActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("antrianlaborat.php");
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnInfoLaboratActionPerformed

    private void MnInfoLaborat1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInfoLaborat1ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("antrianlaborat2.php");
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnInfoLaborat1ActionPerformed

    private void MnInfoLaborat2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInfoLaborat2ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("antrianradiologi.php");
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnInfoLaborat3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInfoLaborat3ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void MnRekapHadir8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapHadir8ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("antrianfarmasiracikan.php");
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnRekapHadir11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnRekapHadir11ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Valid.panggilUrl("antrianfarmasinonracikan.php");
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnRekapHadir11ActionPerformed

    private void MnInfoMobileJKNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnInfoMobileJKNActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private void btnKasirActionPerformed(java.awt.event.ActionEvent evt) {
        BtnToolKasirActionPerformed(evt);
    }
    ...
    private void btnPenggajianActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            if (akses.getpegawai_admin() == true) {
                penggajian.LoadPenggajian("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB") + "/" + "penggajian/login.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&level=admin");
            } else if (akses.getpegawai_user() == true) {
                penggajian.LoadPenggajian("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB") + "/" + "penggajian/login.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&level=user");
            }
        } catch (Exception ex) {
            System.out.println("Notifikasi : " + ex);
        }
    ...
    private void btnRekapPresensiActionPerformed(java.awt.event.ActionEvent evt) {
        MnRekapHadirActionPerformed(evt);
    }

    private void btnRekapHarianActionPerformed(java.awt.event.ActionEvent evt) {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        isTutup();
    ...
    private void btnRekapBulananActionPerformed(java.awt.event.ActionEvent evt) {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        isTutup();
    ...
    private void btnInaCBGKlaimBaruOtomatisActionPerformed(java.awt.event.ActionEvent evt) {
        if (akses.getkode().equals("Admin Utama")) {
            ...
            if (!coder_nik.equals("")) {
                ...
                this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
                try {
                    inacbgklaim.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB") + "/" + "inacbg/login.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "&page=KlaimBaruOtomatis&codernik=" + coder_nik);
                } catch (Exception ex) {
                    System.out.println("Notifikasi : " + ex);
                }
                inacbgklaim.setSize(PanelUtama.getWidth(), PanelUtama.getHeight());
    ...
    private void btnInaCBGKlaimBaruManualActionPerformed(java.awt.event.ActionEvent evt) {
        if (akses.getkode().equals("Admin Utama")) {
        ...
        showForm(berkas, () -> {
            ...
            try {
                if (akses.gethapus_berkas_digital_perawatan() == true) {
                    berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB") + "/" + "berkasrawat/login.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "");
                } else {
                    berkas.loadURL("http://" + koneksiDB.HOSTHYBRIDWEB() + ":" + prop.getProperty("PORTWEB") + "/" + prop.getProperty("HYBRIDWEB") + "/" + "berkasrawat/loginnonhapus.php?act=login&usere=" + koneksiDB.USERHYBRIDWEB() + "&passwordte=" + koneksiDB.PASHYBRIDWEB() + "");
                }
            } catch (Exception ex) {
                System.out.println("Notifikasi : " + ex);
            }
    ...
    private void btnPengaduanActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void addMenu(boolean access, widget.ButtonBig... buttons) {
        if (!access) {
            return;
        }
    ...
    private void addMenu(widget.ButtonBig... buttons) {
        addMenu(true, buttons);
    }

    private void populateMenuPanel() {
        jmlmenu = 0;
        boolean allTabs = !ChkInput.isSelected();
        int selected = cmbMenu.getSelectedIndex();

        if (selected == 0 || allTabs) {
            populateMenuRegistrasiPelayananBilling();
        }

        if (selected == 1 || allTabs) {
            populateMenuBarcodeKesling();
        }

        if (selected == 2 || allTabs) {
            populateMenuKepegawaian();
        }

        if (selected == 3 || allTabs) {
            populateMenuInventoryMedis();
        }

        if (selected == 4 || allTabs) {
            populateMenuInventoryNonMedis();
        }

        if (selected == 5 || allTabs) {
            populateMenuDapur();
        }

        if (selected == 6 || allTabs) {
            populateMenuAsetInventaris();
        }

        if (selected == 7 || allTabs) {
            populateMenuParkir();
        }

        if (selected == 8 || allTabs) {
            populateMenuTagihanRanapRalan();
        }

        if (selected == 9 || allTabs) {
            populateMenuPenyakitLaporan();
        }

        if (selected == 10 || allTabs) {
            populateMenuTarifKeuanganAkuntansi();
        }

        if (selected == 11 || allTabs) {
            populateMenuBridging();
        }

        if (selected == 12 || allTabs) {
            populateMenuRekamMedis();
        }

        if (selected == 13 || allTabs) {
            populateMenuTranfusiDarah();
        }

        if (selected == 14 || allTabs) {
            populateMenuDashboardGrafik();
        }

        if (selected == 15 || allTabs) {
            populateMenuSurat();
        }

        if (selected == 16 || allTabs) {
            populateMenuPerpustakaan();
        }

        if (selected == 17 || allTabs) {
            populateMenuPCRAICRA();
        }

        if (selected == 18 || allTabs) {
            populateMenuTokoKoperasi();
        }

        if (selected == 19 || allTabs) {
            populateMenuFilantropiCSR();
        }

        if (selected == 20 || allTabs) {
            populateMenuPengaturanAplikasi();
        }

    }

    private void populateMenuRegistrasiPelayananBilling() {
    ...
    private void populateMenuBarcodeKesling() {
    ...
    private void populateMenuKepegawaian() {
    ...
    private void populateMenuInventoryMedis() {
    ...
    private void populateMenuInventoryNonMedis() {
            addMenu(akses.getasal_hibah(), btnAsalHibah);
    ...
    private void populateMenuDapur() {
            addMenu(akses.getasal_hibah(), btnAsalHibah);
    ...
    private void populateMenuAsetInventaris() {
            addMenu(akses.getasal_hibah(), btnAsalHibah);
    ...
    private void populateMenuParkir() {
    ...
    private void populateMenuTagihanRanapRalan() {
    ...
    private void populateMenuPenyakitLaporan() {
    ...
    private void populateMenuTarifKeuanganAkuntansi() {
    ...
    private void populateMenuBridging() {
            ...
            addMenu(akses.getmapping_prosedur_smart_klaim_bpjs(), btnMappingProsedurSmartKlaimBPJS);

            addMenu(akses.getmapping_penyakit_smart_klaim_bpjs(), btnMappingPenyakitSmartKlaimBPJS);

            addMenu(akses.getbridging_smart_klaim_bpjs(), btnKirimFHIRSmartKlaimBPJS);
            ...
            addMenu(akses.getsatu_sehat_mapping_kptl_tindakan_ralan(), btnMapingTarifTindakanRalanKPTLSatuSehat);

            addMenu(akses.getsatu_sehat_mapping_kptl_tindakan_ranap(), btnMapingTarifTindakanRanapKPTLSatuSehat);

            addMenu(akses.getsatu_sehat_mapping_kptl_tindakan_radiologi(), btnMapingTarifTindakanRadiologiKPTLSatuSehat);

            addMenu(akses.getsatu_sehat_mapping_kptl_tindakan_laborat(), btnMapingTarifTindakanLabKPTLSatuSehat);
    ...
    private void populateMenuRekamMedis() {
    ...
    private void populateMenuTranfusiDarah() {
    ...
    private void populateMenuDashboardGrafik() {
    ...
    private void populateMenuSurat() {
            ...
            addMenu(akses.getsurat_keterangan_berobat(), btnSuratKeteranganBerobat);
            ...
            addMenu(akses.getsurat_penolakan_resusitasi(), btnSuratPenolakanResusitasi);

            addMenu(akses.getsurat_pengajuan_cuti_pasien(), btnSuratPengajuanCutiPerawatan);
    }

    private void populateMenuPerpustakaan() {
    ...
    private void populateMenuPCRAICRA() {
    ...
    private void populateMenuTokoKoperasi() {
            addMenu(akses.getsatuan_barang(), btnSatuan);
    ...
    private void populateMenuFilantropiCSR() {
    ...
    private widget.ButtonBig createMenuButton(String iconPath, String text, String name, java.awt.Dimension preferedSize, java.awt.event.ActionListener actionListener) {
        widget.ButtonBig button = new widget.ButtonBig();
    ...
    private void initKhanza2() {
        ...
        btnSuratPengajuanCutiPerawatan = createMenuButton("/48x48/writing_2593639.png", "Surat Pegajuan Cuti Perawatan", "btnSuratPengajuanCutiPerawatan", this::btnSuratPengajuanCutiPerawatanActionPerformed);
        ...
        btnMapingTarifTindakanRadiologiKPTLSatuSehat = createMenuButton("/48x48/satusehat.png", "Mapping Tindakan Radiologi KPTL Satu Sehat", "btnMapingTarifTindakanRadiologiKPTLSatuSehat", this::btnMapingTarifTindakanRadiologiKPTLSatuSehatActionPerformed);

        btnMapingTarifTindakanLabKPTLSatuSehat = createMenuButton("/48x48/satusehat.png", "Mapping Tindakan Lab KPTL Satu Sehat", "btnMapingTarifTindakanLabKPTLSatuSehat", this::btnMapingTarifTindakanLabKPTLSatuSehatActionPerformed);

        btnMapingTarifTindakanOperasiKPTLSatuSehat = createMenuButton("/48x48/satusehat.png", "Mapping Tindakan Operasi KPTL Satu Sehat", "btnMapingTarifTindakanOperasiKPTLSatuSehat", this::btnMapingTarifTindakanOperasiKPTLSatuSehatActionPerformed);
