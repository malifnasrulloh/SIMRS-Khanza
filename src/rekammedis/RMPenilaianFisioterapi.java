...
public final class RMPenilaianFisioterapi extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        ...
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianfisioterapi_panelwall1", PanelWall1, "/picture/fisiobody.png")
                    );
    ...
    private void MnPenilaianFisioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianFisioActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianfisioterapi_panelwall1", "/picture/fisiobody.png"));   
    ...
    */
    ...
    private void isRawat() {
        ...
        try {
            psCheck = koneksi.prepareStatement("select no_rawat from penilaian_fisioterapi where no_rawat=? limit 1");
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_fisioterapi where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianfisioterapi_panelwall1", PanelWall1, "/picture/fisiobody.png");
