...
public final class RMPenilaianAwalMedisRanapDewasa extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalmedisranapdewasa_panelwall", new javax.swing.ImageIcon(getClass().getResource("/picture/semua.png")),
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianawalmedisranapdewasa_panelwall", PanelWall, "/picture/semua.png")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianawalmedisranapdewasa_panelwall", "/picture/semua.png")); 
    ...
    */
    ...
    private void isRawat() {
        ...
        try {
            psCheck = koneksi.prepareStatement("select no_rawat from penilaian_medis_ranap where no_rawat=? limit 1");
            ...
            try {
                ...
                if (rsPemeriksaan.next()) {
                    ...
                    try {
                        ...
                        if (rsTriase.next()) {
                            TD.setText(rsTriase.getString("tekanan_darah") != null ? rsTriase.getString("tekanan_darah") : "");
                        Nadi.setText(rsTriase.getString("nadi") != null ? rsTriase.getString("nadi") : "");
                        RR.setText(rsTriase.getString("pernapasan") != null ? rsTriase.getString("pernapasan") : "");
                        Suhu.setText(rsTriase.getString("suhu") != null ? rsTriase.getString("suhu") : "");
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ranap where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianawalmedisranapdewasa_panelwall", PanelWall, "/picture/semua.png");
