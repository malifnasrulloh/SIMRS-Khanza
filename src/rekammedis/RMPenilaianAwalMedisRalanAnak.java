...
public final class RMPenilaianAwalMedisRalanAnak extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalmedisralananak_panelwall", new javax.swing.ImageIcon(getClass().getResource("/picture/semua.png")),
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianawalmedisralananak_panelwall", PanelWall, "/picture/semua.png")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianawalmedisralananak_panelwall", "/picture/semua.png")); 
    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_anak where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_medis_ralan_anak: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    if (rsPemeriksaan.next()) {
                        ...
                        SPO.setText(rsPemeriksaan.getString("spo2") != null ? rsPemeriksaan.getString("spo2") : "");
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_medis_ralan_anak: " + e);
                } finally {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_anak where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianawalmedisralananak_panelwall", PanelWall, "/picture/semua.png");
