            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmmonitoringbromagepascaanestesi_panelwall", PanelWall.getBackgroundImage(),
    ...
    */
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmmonitoringbromagepascaanestesi_panelwall");
            ...
            if (rsG.next()) {
                ...
                PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/bromage_score.png")));
            }
            rsG.close();
            psG.close();
        } catch (Exception e) {
