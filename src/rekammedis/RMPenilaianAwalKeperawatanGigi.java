    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_awal_keperawatan_gigi where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_awal_keperawatan_gigi: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_awal_keperawatan_gigi: " + e);
                } finally {
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmpenilaianawalkeperawatangigi_panelwall");
