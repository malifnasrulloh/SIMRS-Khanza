...
public final class RMCatatanAnastesiSedasi extends javax.swing.JDialog {
    ...
    */
    ...
    private void isRawat() {
        ...
        try {
            psCheck = koneksi.prepareStatement("select no_rawat from catatan_anestesi_sedasi where no_rawat=? limit 1");
        ...
        if (!exists) {
            ...
            try {
                ...
                if (rsPemeriksaan.next()) {
                    ...
                    String al = rsPemeriksaan.getString("alergi");
                    if (al != null && !al.trim().isEmpty() && !al.trim().equals("-") && !al.trim().equalsIgnoreCase("tidak ada")) {
                        Alergi.setSelectedItem("Ya");
                    } else {
                        Alergi.setSelectedItem("Tidak");
                    }
