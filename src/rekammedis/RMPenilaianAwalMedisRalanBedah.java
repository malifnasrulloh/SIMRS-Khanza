...
public final class RMPenilaianAwalMedisRalanBedah extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalmedisralanbedah_panelwall", new javax.swing.ImageIcon(getClass().getResource("/picture/LokalisOrtho.png")),
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianawalmedisralanbedah_panelwall", PanelWall, "/picture/LokalisOrtho.png")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianawalmedisralanbedah_panelwall", "/picture/LokalisOrtho.png"));
    ...
    */
    ...
    public void emptTeks() {
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/LokalisOrtho.png")));
        PanelWall.repaint();
    } 
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_bedah where no_rawat=?");
                ...
                System.out.println("Notif check medis bedah: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    psPemeriksaan = koneksi.prepareStatement(
                        "select suhu_tubuh, tensi, nadi, respirasi, berat, gcs, kesadaran, keluhan, alergi " +
                    ...
                    System.out.println("Notif fetch pemeriksaan medis bedah: " + e);
                } finally {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_bedah where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianawalmedisralanbedah_panelwall", PanelWall, "/picture/LokalisOrtho.png");
