...
public final class RMPenilaianAwalMedisRalanRehabMedik extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalmedisralanrehabmedik_panelwall1", new javax.swing.ImageIcon(getClass().getResource("/picture/nyeri.png")),
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianawalmedisralanrehabmedik_panelwall1", PanelWall1, "/picture/LokalisOrtho.png")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianawalmedisralanrehabmedik_panelwall1", "/picture/nyeri.png"));
    ...
    */
    ...
    public void emptTeks() {
        ...
        PanelWall1.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/nyeri.png")));
        PanelWall1.repaint();
    } 
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_rehab_medik where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_medis_ralan_rehab_medik: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_medis_ralan_rehab_medik: " + e);
                } finally {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_rehab_medik where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianawalmedisralanrehabmedik_panelwall1", PanelWall1, "/picture/LokalisOrtho.png");
