...
public final class RMPenilaianAwalKeperawatanIGD extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalkeperawatanigd_panelwall", PanelWall.getBackgroundImage(),
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        try {
            if(Valid.minutesOld("./cache/masalahkeperawatanigd.iyem") < 5){
    ...
    */
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmpenilaianawalkeperawatanigd_panelwall");
