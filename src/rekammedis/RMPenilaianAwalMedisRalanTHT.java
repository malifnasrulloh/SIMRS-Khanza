...
public final class RMPenilaianAwalMedisRalanTHT extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalmedisralantht_panelwall", new javax.swing.ImageIcon(getClass().getResource("/picture/medis awal THT.png")),
                        () -> LokalisCanvas.loadGambar(koneksi, TNoRw.getText(), "rmpenilaianawalmedisralantht_panelwall", PanelWall, "/picture/medis awal THT.png")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if(tbObat.getSelectedRow()>-1){
            ...
            param.put("lokalis", LokalisCanvas.getLokalisStream(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString(), "rmpenilaianawalmedisralantht_panelwall", "/picture/medis awal THT.png")); 
    ...
    */
    ...
    public void emptTeks() {
        ...
        PanelWall.setBackgroundImage(new javax.swing.ImageIcon(getClass().getResource("/picture/medis awal THT.png")));
        PanelWall.repaint();
    } 
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_tht where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_medis_ralan_tht: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_medis_ralan_tht: " + e);
                } finally {
    ...
    private void hapus() {
        if(Sequel.queryu2tf("delete from penilaian_medis_ralan_tht where no_rawat=?",1,new String[]{
            tbObat.getValueAt(tbObat.getSelectedRow(),0).toString()
                        ...
                        LokalisCanvas.hapusGambar(koneksi, tbObat.getValueAt(tbObat.getSelectedRow(),0).toString(), "rmpenilaianawalmedisralantht_panelwall", PanelWall, "/picture/medis awal THT.png");
