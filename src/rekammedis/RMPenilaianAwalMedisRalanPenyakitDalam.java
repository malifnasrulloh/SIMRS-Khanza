    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_penyakit_dalam where no_rawat=?");
                ...
                System.out.println("Notif check medis penyakit dalam: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    psPemeriksaan = koneksi.prepareStatement(
                        "select suhu_tubuh, tensi, nadi, respirasi, berat, gcs, keluhan, alergi " +
                    ...
                    System.out.println("Notif fetch pemeriksaan medis penyakit dalam: " + e);
                } finally {
