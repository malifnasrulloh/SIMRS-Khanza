            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmpenilaianawalkeperawatanralangeriatri_panelwall", PanelWall.getBackgroundImage(),
    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_awal_keperawatan_ralan_geriatri where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_awal_keperawatan_ralan_geriatri: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_awal_keperawatan_ralan_geriatri: " + e);
                } finally {
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmpenilaianawalkeperawatanralangeriatri_panelwall");
