    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_medis_ralan_psikiatrik where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_medis_ralan_psikiatrik: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_medis_ralan_psikiatrik: " + e);
                } finally {
