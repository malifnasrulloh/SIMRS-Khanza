    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_awal_keperawatan_mata where no_rawat=?");
                ...
                System.out.println("Notif check penilaian_awal_keperawatan_mata: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    ...
                    System.out.println("Notif fetch triase/pemeriksaan penilaian_awal_keperawatan_mata: " + e);
                } finally {
