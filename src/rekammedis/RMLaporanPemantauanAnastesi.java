...
public final class RMLaporanPemantauanAnastesi extends javax.swing.JDialog {
            ...
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                if (!TNoRw.getText().trim().equals("")) {
                    LokalisCanvas canvas = new LokalisCanvas(
                        null, true, koneksi, TNoRw.getText(), "rmlaporanpemantauananastesi_panelwall", PanelWall.getBackgroundImage(),
    ...
    */
    ...
    private void isRawat() {
        ...
        try {
            psCheck = koneksi.prepareStatement("select no_rawat from penilaian_awal_keperawatan_kebidanan_ranap where no_rawat=? limit 1");
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmlaporanpemantauananastesi_panelwall");
