    ...
    */
    ...
    private void isRawat() {
        try {
            ...
            try {
                psCheck = koneksi.prepareStatement("select count(*) from penilaian_awal_keperawatan_ralan where no_rawat=?");
                ...
                System.out.println("Notif check keperawatan: " + e);
            } finally {
                if (rsCheck != null) {
            ...
            if (!exists) {
                ...
                try {
                    psPemeriksaan = koneksi.prepareStatement(
                        "select suhu_tubuh, tensi, nadi, respirasi, tinggi, berat, gcs, keluhan, alergi " +
                    ...
                    System.out.println("Notif fetch pemeriksaan keperawatan: " + e);
                } finally {
    ...
    private void loadGambar_PanelWall() {
        try {
            ...
            psG.setString(2, "rmpenilaianawalkeperawatanralan_panelwall");
