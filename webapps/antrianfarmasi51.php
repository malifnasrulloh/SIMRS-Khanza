...
<head>
    <title>Layar Informasi – Antrean Farmasi</title>
...
<body>
        ...
        <div class="ticker-footer">
            ...
            <div class="ticker-track">
                <div class="ticker-inner">
                    ...
                    <span class="ticker-item">Estimasi waktu pelayanan: <b>Obat Non-Racikan 15 - 30 Menit</b> &bull; <b>Obat Racikan 30 - 60 Menit</b></span>
                    <span style="opacity:0.4;padding:0 2vw;color:#fff;">◆</span>
    ...
    <script>
        ...
        function load() {
            $('#data').load('data_antrianfarmasi51.php', function() {
                setupScroll();
            });
        }
        load();
