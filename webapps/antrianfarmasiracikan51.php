...
<head>
    <title>Layar Informasi – Antrean Farmasi Racikan</title>
...
<body>
    <div class="screen">
        ...
        <div class="ticker-footer">
            <div class="ticker-label">&#128138; Pelayanan Obat Racikan</div>
            <div class="ticker-track">
                <div class="ticker-inner">
                    <span class="ticker-item">Estimasi waktu peracikan obat: <b>30 - 60 Menit</b> (menyesuaikan jumlah &amp; kompleksitas formula)</span>
                    <span style="opacity:0.4;padding:0 2vw;color:#fff;">◆</span>
                    <span class="ticker-item">Proses peracikan melibatkan <b>Penimbangan, Pencampuran, dan Pengemasan Khusus</b> demi ketepatan dosis</span>
                    <span style="opacity:0.4;padding:0 2vw;color:#fff;">◆</span>
                    <span class="ticker-item">Pastikan mencocokkan <b>Nomor Resep &amp; Nama Pasien</b> saat penyerahan obat di loket</span>
                    <span style="opacity:0.4;padding:0 2vw;color:#fff;">◆</span>
                    <span class="ticker-item">Konsultasikan aturan pakai kepada <b>Apoteker / Tenaga Teknis Kefarmasian</b></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function load() {
            $('#data').load('data_antrianfarmasiracikan51.php', function() {
                setupScroll();
            });
        }
        load();
