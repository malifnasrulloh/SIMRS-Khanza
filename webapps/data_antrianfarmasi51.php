    ...
    <div class="pharmacy-left">
            ...
            <div class="card-head">
                <div class="card-head-left">
                    ...
                    <div>
                        ...
                        <div class="card-sub">Obat siap diambil di loket apotek</div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-head">
                <div class="card-head-left">
                    ...
                    <div>
                        ...
                        <div class="card-sub">Resep divalidasi, silakan menunggu proses</div>
                    </div>
                </div>
            </div>
            <div class="hero-call-body">
        ...
        <div class="kpi-grid">
            <div class="kpi-box">
                ...
                <div class="kpi-lbl">Total Resep</div>
            </div>
            ...
            <div class="kpi-box bl">
                ...
                <div class="kpi-lbl">Sedang Diracik / Proses</div>
            </div>
        ...
        <div class="card" style="height: 100%;">
            <div class="card-head">
                <div class="card-head-left">
                    ...
                    <div>
                        <div class="card-title">Antrean Resep Rawat Jalan</div>
                    ...
                    <table class="t">
                        ...
                        <tbody id="queueBody">
                            ...
                            while ($data = mysqli_fetch_array($hasil)) {
                                $total++;
                                $isRacik = (getOne("select count(resep_dokter_racikan.no_resep) from resep_dokter_racikan where resep_dokter_racikan.no_resep='" . $data['no_resep'] . "'") > 0);
                                $jenis = $isRacik ? 'Racikan' : 'Non Racikan';
                                $jenisClass = $isRacik ? 'b-racik' : 'b-nonracik';
                            ...
                            <tr>
                                ...
                                <td class="c"><span class="badge <?php echo $jenisClass; ?>"><?php echo $jenis; ?></span></td>
...
<script>
    ...
    (function pollCalls() {
        fetch('api_antrian_call.php?type=combined')
            .then(r => r.json())
            .then(d => {
                // Penyerahan Obat
