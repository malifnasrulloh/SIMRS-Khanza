    ...
    <div class="pharmacy-left">
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-box bl">
                ...
                <div class="kpi-lbl">Sedang Disiapkan</div>
            </div>
        ...
        <div class="card" style="height: 100%;">
            <div class="card-head">
                <div class="card-head-left">
                    ...
                    <div>
                        <div class="card-title">Antrean Resep Non Racikan</div>
            ...
            <div class="table-wrap">
                <div class="scroll-inner" id="scrollInner">
                    ...
                    <div class="empty">
                        <span class="material-icons">medication</span>
                        <p>Belum ada resep non racikan hari ini</p>
                    </div>
                    <?php } ?>
                </div>
            </div>
...
<script>
    ...
    (function pollCalls() {
        fetch('api_antrian_call.php?type=nonracikan')
            .then(r => r.json())
            .then(d => {
                // Penyerahan Obat
